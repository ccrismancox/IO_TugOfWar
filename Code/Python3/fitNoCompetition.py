"""
Fitting the no competition model
Sept 2024
"""
...
'''parameters'''
parameters = np.genfromtxt("../R4.4.1/ipoptTEMP/params.csv", delimiter=",")[1:,:]
delta = parameters[0][0]
nK = int(parameters[0][1])
nB = int(parameters[0][2])
agent = int(parameters[0][3])
  


given = genGiven(states, Y, P, nBeta=nB, nKappa=nK, delta=delta, agent=agent)
